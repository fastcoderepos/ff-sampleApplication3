...
import com.fastcode.sampleapplication3.application.core.filmactor.dto.*;
import com.fastcode.sampleapplication3.domain.core.filmactor.IFilmActorRepository;
import com.fastcode.sampleapplication3.domain.core.filmactor.FilmActorEntity;
import com.fastcode.sampleapplication3.domain.core.actor.IActorRepository;
...
import com.fastcode.sampleapplication3.domain.core.filmactor.FilmActorId;
...
public class FilmActorControllerTest {
	...
	public static void cleanup() {
		...
		em.createNativeQuery("truncate table FILM_ACTOR").executeUpdate();
		em.createNativeQuery("truncate table ACTOR").executeUpdate();
